            ...
            <div className="main-box">
                ...
                <div className="box2">
                    ...
                    <input type="text" name="search" className="field" autocomplete="off" placeholder="Search aBuy Help..."/>
                        <button className="button"> <i className="fa-duotone fa-solid fa-magnifying-glass"></i></button>
                </div>
                <div className="box3">
                    ...
                    <div className="hf">
                        ...
                        <i className="fa-sharp-duotone fa-solid fa-thumbs-up"></i>
                        <i className="fa-duotone fa-solid fa-thumbs-down"></i>
                    </div>
                </div>
